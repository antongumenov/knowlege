...
//_ Синхронизация с удалённым репозиторием
...
//_ Игнорирование некоторых файлов
...
git tag -а v1.0.0 54651316 - добавить тег на конкретный коммит
