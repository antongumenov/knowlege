...
// по каналу можно передавать только типы определенного типа

//_ РАБОТА С НЕБУФЕРЕЗИРОВАННЫМИ КАНАЛАМИ 
...
//_ РАБОТА С БУФЕРИЗИРОВАННЫМИ КАНАЛАМИ
...
//_ ЗАКРЫТИЕ КАНАЛА, ПОЛУЧЕНИЕ ЗНАЧЕНИЙ С ПРОВЕРКОЙ НА ЗАКРЫТИЕ
...
//_ ОГРАНИЧЕНИЕ НАПРАВЛЕНИЯ КАНАЛА
...
//_ СИНХРОНИЗАЦИЯ C ПОМОЩЬЮ КАНАЛОВ
