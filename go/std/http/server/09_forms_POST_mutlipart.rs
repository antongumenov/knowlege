//_ ПОЛУЧЕНИЕ ДАННЫХ ИЗ ФОРМ ОТПРАВЛЕННЫХ МЕТОДОМ POST и кодировкой multipart/form-data
...
//_ ЧТЕНИЕ ПОЛЕЙ ФОРМЫ из request.Form, request.PostForm и request.MultipartForm отправленных с enctype="application/x-www-form-urlencoded"
// ~ Form
...
//_ ХЕЛПЕРЫ ДЛЯ ЧТЕНИЕ ПОЛЕЙ ФОРМЫ из request.Form, request.PostForm и request.MultipartForm отправленных с enctype="application/x-www-form-urlencoded"
